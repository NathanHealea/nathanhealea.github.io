<template>
<div id="maintenance" class="container text-center">
	<div id="maintenance-wrapper" class="d-flex align-items-center flex-column justify-content-center h-100">
		<header>
				<h1>Hello World, I'm Nathan Healea</h1>
				<h4><span class="rotate">Programmer Analyst | Full Stack Engineer | Web Developer | Software Engineer</span></h4>
		</header>
		<section class="text-secondary">
			<h3 class="text-uppercase heighlighted-text"><strong>Website Under Maintenance</strong></h3>
		</section>
		<footer>
			<h4>Get In Touch</h4>
			<div class="row">
				<div class="col">
					<a href="mailto:nate.healea@gmail.com.edu">
						<h4><i class="far fa-envelope"></i> nate.healea@gmail.com</h4>
					</a>
				</div>
			</div>
