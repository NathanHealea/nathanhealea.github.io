  ...
  return (
    <FiCard onMouseEnter={toggleContent} onMouseLeave={toggleContent} onClick={toggleContent}>
      ...
      <Fade in={show} style={{ transitionDelay: show ? '125ms' : '0ms' }} >
        <FiCardContent>
          <Title variant="h4" color="secondary" className={classes.title}>{props.title}</Title>


          <Subtitle variant="body2" color="secondary" className={classes.subtitle} >{props.subtitle}</Subtitle>
